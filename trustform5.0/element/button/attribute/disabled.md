---
description: button 컨트롤의 disabled(비활성) 상태를 설정하는 속성
---
...
button 컨트롤의 disabled\(비활성\) 상태를 설정하는 속성이다.
...
{% code title="\[Static\]" %}
```markup
<button id="button1" disabled="true" style="left:90px; top:80px; width:100px; height:20px; "> 
```
{% endcode %}
