...
그리드 subtotal 기능의 자세한 내용은
TrustForm4.0 가이드 > 컨트롤 > grid 컨트롤 > grid 컨트롤 부분 합계 구하기 참고.
...
{% code title="\[Static\]" %}
```markup
<datagrid id="datagrid1" nodeset="/root/g" caption="caption1^caption2^caption3^caption4" colsep="^" colwidth="100, 100, 100, 100" mergecellsfixedrows="bycolrec" multitotal="true" rowsep="|" style="left:30px; top:35px; width:430px; height:225px; "> 
```
{% endcode %}
