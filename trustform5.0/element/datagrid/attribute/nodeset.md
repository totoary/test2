...
{% code title="\[Static\]" %}
```markup
<datagrid id="datagrid1" nodeset="/root/martSample/gridData/itemList/item" caption="caption1^caption2^caption3^caption4" colsep="^" colwidth="100, 100, 100, 100" mergecellsfixedrows="bycolrec" rowsep="|" style="left:45px; top:70px; width:520px; height:195px; "> 
```
{% endcode %}
